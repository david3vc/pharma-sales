package com.iroman.pharmasales.shared.string;
...
public class StringHelper {
    ...
    public String replaceWhiteSpaces(String input, String replacement) {
    ...
    public String slugsKeywords(String input) {
        ...
        return replaceWhiteSpaces(noPunctuation, "-").toLowerCase();
    }
}
